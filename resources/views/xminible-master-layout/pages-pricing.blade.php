                ...
                <div class="col-xl-4">
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <div class="py-4">
                                <h3><sup><small>$</small></sup> 19/ <span class="font-size-13 text-muted">Per month</span>
                                </h3>
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <div class="py-4">
                                <h3><sup><small>$</small></sup> 29/ <span class="font-size-13 text-muted">Per month</span>
                                </h3>
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <div class="py-4">
                                <h3><sup><small>$</small></sup> 49/ <span class="font-size-13 text-muted">Per month</span>
                                </h3>
                            </div>
