                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="card border rounded active shipping-address">
                                        <div class="card-body">
                                            <a href="#" class="float-end ml-1" data-bs-toggle="tooltip" data-placement="top"
                                                title="Edit">
            ...
            <div class="card checkout-order-summary">
                <div class="card-body">
                    <div class="p-3 bg-light mb-4">
                        <h5 class="font-size-16 mb-0">Order Summary <span class="float-end ml-2">#MN0124</span></h5>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-centered mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"><img src="{{ URL::asset('/assets/images/product/img-1.png') }}" alt="product-img"
                                ...
                                <tr>
                                    <th scope="row"><img src="{{ URL::asset('/assets/images/product/img-2.png') }}" alt="product-img"
                                            title="product-img" class="avatar-md"></th>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
