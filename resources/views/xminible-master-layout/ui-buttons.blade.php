        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Add <code>.btn-soft-*</code> class with <code>.btn-*</code> color button for
                        a Soft background buttons.</p>
                    <div class="button-items">
                        <button type="button"
                            class="btn btn-primary btn-soft-primary waves-effect waves-light">Primary</button>
                        <button type="button"
                            class="btn btn-success btn-soft-success waves-effect waves-light">Success</button>
                        <button type="button" class="btn btn-info btn-soft-info waves-effect waves-light">Info</button>
                        <button type="button"
                            class="btn btn-warning btn-soft-warning waves-effect waves-light">Warning</button>
                        <button type="button"
                            class="btn btn-danger btn-soft-danger waves-effect waves-light">Danger</button>
                        <button type="button" class="btn btn-dark btn-soft-dark waves-effect waves-light">Dark</button>
                        <button type="button"
                            class="btn btn-secondary btn-soft-secondary waves-effect waves-light">Secondary</button>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Create block level buttons—those that
                        span the full width of a parent—by adding <code class="highlighter-rouge">d-grid gap-2</code>.</p>

                    <div class="d-grid gap-2">
                        <button type="button" class="btn btn-primary btn-lg btn-block waves-effect waves-light mb-1">Block
                            level button</button>
                        <button type="button" class="btn btn-light btn-sm btn-block waves-effect waves-light">Block level
                            button</button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="btn-group mt-4 mt-md-0" role="group" aria-label="Basic example">
                                ...
                                <button type="button" class="btn btn-light"><i
                                        class="uil uil-align-center-alt"></i></button>
