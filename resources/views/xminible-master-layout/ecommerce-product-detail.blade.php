                                            ...
                                            <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                                                <div class="product-img">
                                                    <img src="{{ URL::asset('/assets/images/product/img-1.png') }}" alt=""
                                                        ...
                                                        data-zoom="{{ URL::asset('/assets/images/product/img-1.png') }}">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                ...
                                                <ul class="list-unstyled product-desc-list text-muted">
                                                    <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> High Quality
                                                    </li>
                                                    <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> Leather</li>
                                                    <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> All Sizes
                                                        available</li>
                                                    <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> 4 Different
                                                        Color</li>
                                                </ul>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                ...
                                                <ul class="list-unstyled product-desc-list text-muted">
                                                    <li><i class="uil uil-exchange text-primary me-1 font-size-16"></i> 10
                                                        Days Replacement</li>
                                                    <li><i class="uil uil-bill text-primary me-1 font-size-16"></i> Cash on
                                            ...
                                            <div class="product-desc-color mt-3">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="#" class="active" data-bs-toggle="tooltip"
                        ...
                        <div class="product-desc">
                            ...
                            <div class="tab-content border border-top-0 p-4">
                                <div class="tab-pane fade" id="desc" role="tabpanel">
                                    <div class="row">
                                        <div class="col-sm-3 col-md-2">assets
                                            <div>
                                                <img src="{{ URL::asset('/assets/images/product/img-6.png') }}" alt=""
                                                    class="img-fluid mx-auto d-block">
                                            </div>
                                            ...
                                            <div class="text-muted p-2">
                                                ...
                                                <div>
                                                    <ul class="list-unstyled product-desc-list text-muted">
                                                        ...
                                                        <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> Neque
                                                            porro quisquam est</li>
                                                        <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> Quis
