...
class HasilWPController extends Controller
{
    ...
    public function index()
    {
    	...
    	return view('hasilwp', compact('kriteria','alternatif','relasi','jmlh_kriteria','jmlh_alternatif','normalisasi','normalisasi_terbobot','positif','negatif','hasil_positif','hasil_negatif','preferensi','rangking'));
    }
}
